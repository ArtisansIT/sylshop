                            ...
                            <div class="category-banners-slider  data-toggle="owl" 
                               >
                                <div class="banner banner-poster">
                                    ...
                                    <a href="#">
                                         <img src="{{ asset('images/'.$shop->image->banner) }}" alt="Banner">
                                    </a>
                        ...
                        <aside class="col-lg-3 col-xl-5col order-lg-first">
                            <div class="sidebar sidebar-shop">
                                <div class="widget widget-categories">
                                    <h3 class="widget-title">Shop Details</h3><!-- End .widget-title -->
                                            ...
                                            <div class="acc-item">
                                                ...
                                                <div id="collapse-1" class="collapse show" data-parent="#widget-cat-acc">
                                                    <div class="collapse-wrap">
                                                        <ul>
                                                            <li><a href="#" class="btn-product btn-wishlist" title="All view"><span>40 view</span></a></li>
															<li><a href="#" class="btn-product btn-cart" title="Address"><span>Tilagor, Sylhet</span></a></li>
                                                            <li><a href="#" class="btn-product btn-wishlist" title="Love"><span>wishlist</span></a></li>
                                                            <li><a href="#" class="btn-product btn-cart" title="Shipping Fee"><span>Shipping Fee:  40</span></a></li>
															<li><a href="#" class="btn-product btn-compare" title="Shop Chat"><span>Chat</span></a></li>
                                                        </ul>
