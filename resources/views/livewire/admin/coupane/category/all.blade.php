<div>
                        ...
                        <div class="card-header-form">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <button wire:click="$emit('category_inactive_list')" class="btn btn-warning btn-icon icon-left">
        ...
        @elseif($edit_category == true)
             @livewire('admin.coupane.category.edit',[
                 'coupane_id' => $coupane_id
             ])            
        @elseif($inactive_list_category == true)
             @livewire('admin.coupane.category.inactive')            
        @endif
