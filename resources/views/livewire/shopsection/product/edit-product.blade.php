    ...
    <div class="card-body">
        ...
        <form wire:submit.prevent="updateProduct">
            ...
            <div class="form-group">
                ...
                <input type="number" wire:model="main_price" name="name" class="form-control form-control-sm">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" wire:model="offer_price" name="name" class="form-control form-control-sm">
            </div>
