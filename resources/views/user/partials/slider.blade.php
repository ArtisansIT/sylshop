<div class="intro-slider-container">
    <div class="intro-slider owl-carousel owl-simple owl-nav-inside" data-toggle="owl" data-owl-options='{
        ...
        <div class="intro-slide" style="background-image: url({{ asset('user/assets/images/demos/demo-13/slider/slide-1.png') }});">
        ...
        <div class="intro-slide" style="background-image: url({{ asset('user/assets/images/demos/demo-13/slider/slide-2.jpg') }});">
            <div class="container intro-content">
                <div class="row">
                    <div class="col-auto offset-lg-3 intro-col">
        ...
        <div class="intro-slide" style="background-image: url({{ asset('user/assets/images/demos/demo-13/slider/slide-3.jpg') }});">
            <div class="container intro-content">
                <div class="row">
                    <div class="col-auto offset-lg-3 intro-col">
