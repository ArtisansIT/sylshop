            ...
            <div class="row">
                <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                    <div class="product">
                        <figure class="product-media">
                            ...
                            <a href="product.html">
                                <img src="{{ asset('user/assets/images/products/product-1.jpg') }}" alt="Product image" class="product-image">
                            </a>
                ...
                <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                    <div class="product">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{ asset('user/assets/images/products/product-2.jpg') }}" alt="Product image" class="product-image">
                            </a>
                ...
                <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                    <div class="product">
                        <figure class="product-media">
                            ...
                            <a href="product.html">
                                <img src="{{ asset('user/assets/images/products/product-3.jpg') }}" alt="Product image" class="product-image">
                            </a>
                ...
                <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                    <div class="product">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{ asset('user/assets/images/products/product-4.jpg') }}" alt="Product image" class="product-image">
                            </a>
                ...
                <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                    <div class="product">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{ asset('user/assets/images/products/product-5.jpg') }}" alt="Product image" class="product-image">
                            </a>
                ...
                <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                    <div class="product">
                        <figure class="product-media">
                            ...
                            <a href="product.html">
                                <img src="{{ asset('user/assets/images/products/product-6.jpg') }}" alt="Product image" class="product-image">
                            </a>
                ...
                <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                    <div class="product">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{ asset('user/assets/images/products/product-7.jpg') }}" alt="Product image" class="product-image">
                            </a>
                ...
                <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                    <div class="product">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{ asset('user/assets/images/products/product-8.jpg') }}" alt="Product image" class="product-image">
                            </a>
                ...
                <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                    <div class="product">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{ asset('user/assets/images/products/product-9.jpg') }}" alt="Product image" class="product-image">
                            </a>
                ...
                <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                    <div class="product">
                        <figure class="product-media">
                            <span class="product-label label-new">New</span>
                            <a href="product.html">
                                <img src="{{ asset('user/assets/images/products/product-10.jpg') }}" alt="Product image" class="product-image">
                            </a>
                ...
                <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                    <div class="product">
                        <figure class="product-media">
                            ...
                            <a href="product.html">
                                <img src="{{ asset('user/assets/images/products/product-11.jpg') }}" alt="Product image" class="product-image">
                            </a>
                ...
                <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                    <div class="product">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{ asset('user/assets/images/products/product-12.jpg') }}" alt="Product image" class="product-image">
                            </a>
